...
OPENAI_API_KEY = OPENAI#"sk-proj-QZ0dcGXN1l89JwEmQzXOT3BlbkFJxDduyUsfDNE7e3cO91U8"#"use own API token" # replace this with your openai api key or store the api key in env
